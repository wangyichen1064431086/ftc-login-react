(function (global, factory) {
	...
	*/
	...
	unwrapExports(generateAppendClassName);
	...
	unwrapExports(extendReactClass);
	...
	unwrapExports(wrapStatelessFunction);
	...
	unwrapExports(makeConfiguration);
	...
	var CSSModules = unwrapExports(dist);
	...
	var css = "@charset \"UTF-8\";\n.login_bgshadow__3CR5a {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 10;\n  display: block;\n  background-color: rgba(0, 0, 0, 0.7);\n  text-align: center; }\n  .login_bgshadow__3CR5a::before {\n    height: 100%;\n    content: \"\";\n    display: inline-block;\n    vertical-align: middle; }\n\n.login_bgshadow--close__3QE2w {\n  display: none; }\n\n.login_overlay-window__BW8Ya {\n  background-color: #fff1e0;\n  display: inline-block;\n  width: 300px;\n  vertical-align: middle;\n  z-index: 20; }\n\n.login_overlay-title__16xdp {\n  background-color: #918f83;\n  color: #fff;\n  position: relative;\n  height: 52px;\n  padding: 15px;\n  box-sizing: border-box;\n  font-size: 16px;\n  text-align: left; }\n  .login_overlay-title__16xdp .login_overlay-close__3HboG {\n    position: absolute;\n    display: inline-block;\n    padding: 0;\n    top: 0px;\n    height: 100%;\n    right: 15px;\n    font-size: 43px;\n    /*待整理：纯CSS写出来的关闭x号*/\n    font-family: Arial;\n    font-weight: 400;\n    cursor: pointer; }\n\n.login_overlay-form__Wjh9b {\n  height: 240px;\n  padding: 25px 0 0 0; }\n\n.login_form-item__2osD- {\n  height: 60px;\n  padding: 15px; }\n  .login_form-item__2osD- label {\n    display: block;\n    height: 22px;\n    padding-bottom: 7.5px;\n    text-align: left; }\n  .login_form-item__2osD- input {\n    display: block;\n    box-sizing: border-box;\n    height: 36px;\n    width: 100%;\n    padding: 7px;\n    border: 1px solid #cec6b9;\n    border-radius: 5px;\n    font-size: 16px;\n    background-color: #faffbd; }\n  .login_form-item__2osD- .login_inputerror__2gObL {\n    font-size: 14px;\n    line-height: 16px;\n    color: #c00;\n    clear: both;\n    margin-top: -1px;\n    padding: 3px 0;\n    text-align: left; }\n\n.login_saveandsub__2j_hI {\n  height: 36px;\n  padding: 7.5px 15px;\n  text-align: left;\n  line-height: 36px; }\n  .login_saveandsub__2j_hI .login_saveme__15PoU {\n    margin: 0;\n    padding: 0; }\n  .login_saveandsub__2j_hI .login_submit__1vGEx {\n    display: inline-block;\n    float: right;\n    height: 100%;\n    padding: 0px;\n    width: 68px;\n    color: #fff;\n    background: #2e6e9e;\n    border: 1px solid #2e6e9e;\n    border-radius: 5px;\n    outline: none;\n    font-size: 16px; }\n\n.login_overlay-bottom__2bQJH {\n  padding: 7.5px 15px; }\n  .login_overlay-bottom__2bQJH .login_overlay-bottomline__1ToyD {\n    text-align: left;\n    height: 36px;\n    box-sizing: border-box;\n    border-bottom: 7.5px; }\n    .login_overlay-bottom__2bQJH .login_overlay-bottomline__1ToyD a {\n      color: #2e6e9e;\n      text-decoration: none; }\n";
	var login = { "bgshadow": "login_bgshadow__3CR5a", "bgshadow--close": "login_bgshadow--close__3QE2w", "overlay-window": "login_overlay-window__BW8Ya", "overlay-title": "login_overlay-title__16xdp", "overlay-close": "login_overlay-close__3HboG", "overlay-form": "login_overlay-form__Wjh9b", "form-item": "login_form-item__2osD-", "inputerror": "login_inputerror__2gObL", "saveandsub": "login_saveandsub__2j_hI", "saveme": "login_saveme__15PoU", "submit": "login_submit__1vGEx", "overlay-bottom": "login_overlay-bottom__2bQJH", "overlay-bottomline": "login_overlay-bottomline__1ToyD" };
	styleInject(css);
	...
	var Login = (_dec = CSSModules(login, { allowMultiple: true }), _dec(_class = (_temp = _class2 = function (_React$Component) {
	  ...
	  createClass(Login, [{
	    ...
	    key: 'handleChange',
	    value: function handleChange(fieldname, e) {
	      switch (fieldname) {
	        case 'email':
	        case 'password':
	          var value = e.target.value;

	          this.setState(defineProperty$1({}, fieldname, value));
	          break;
	        case 'saveme':
	    ...
	    key: 'validateEmail',
	    value: function validateEmail(email, e) {
	      if (email === '') {
	        this.setState({
	    ...
	    key: 'renderOverlayHead',
	    value: function renderOverlayHead() {
	      return react.createElement(
	        'div',
	        { styleName: 'overlay-title' },
	        '\u767B\u5F55',
	        react.createElement(
	          'span',
	          { styleName: 'overlay-close', onClick: this.closeOverlay },
	          '\xD7'
	        )
	      );
	    }
	    ...
	    value: function renderOverlayForm() {
	      var postUrl = this.props.postUrl;
	      var _state = this.state,
	          email = _state.email,
	          password = _state.password,
	          saveme = _state.saveme,
	          errorForEmail = _state.errorForEmail,
	          errorForPassword = _state.errorForPassword;


	      return (//待进一步拆分组件
	        react.createElement(
	          'form',
	          { method: 'post', styleName: 'overlay-form', action: postUrl },
	          react.createElement(
	            'div',
	            { styleName: 'form-item' },
	            react.createElement(
	              'label',
	              { htmlFor: 'ftcLoginEmail' },
	              '\u7535\u5B50\u90AE\u4EF6'
	            ),
	            react.createElement('input', { type: 'text', name: 'email', id: 'ftcLoginEmail', value: email, onChange: this.handleChange.bind(this, 'email'), onBlur: this.validateEmail.bind(this, email) }),
	            react.createElement(
	              'div',
	              { styleName: 'inputerror' },
	              errorForEmail
	            )
	          ),
	          react.createElement(
	            ...
	            react.createElement(
	              'label',
	              { htmlFor: 'ftcLoginPassword' },
	              '\u5BC6\u7801'
	            ),
	            react.createElement('input', { type: 'password', name: 'password', id: 'ftcLoginPassword', value: password, onChange: this.handleChange.bind(this, 'password'), onBlur: this.validatePassword.bind(this, password) }),
	            react.createElement(
	              'div',
	              { styleName: 'inputerror' },
	              errorForPassword
	          ...
	          react.createElement(
	            'div',
	            { styleName: 'saveandsub' },
	            react.createElement('input', { styleName: 'saveme', type: 'checkbox', value: saveme, checked: saveme === '1', name: 'saveme', id: 'ftcLoginSaveme', onChange: this.handleChange.bind(this, 'saveme') }),
	            react.createElement(
	              'label',
	              { htmlFor: 'ftcLoginSaveme' },
	              '\u8BB0\u4F4F\u6211'
	            ),
	            react.createElement('input', { styleName: 'submit', type: 'submit', value: '\u63D0\u4EA4' })
	          )
	        )
	      );
	    }
	    ...
	    value: function renderBottom() {
	      var _props = this.props,
	          findPasswordUrl = _props.findPasswordUrl,
	          registerUrl = _props.registerUrl;
	      ...
	      return react.createElement(
	        ...
	        react.createElement(
	          'div',
	          { styleName: 'overlay-bottomline' },
	          react.createElement(
	            'a',
	            { href: findPasswordUrl },
	            '\u627E\u56DE\u5BC6\u7801'
	          )
	        ),
	        react.createElement(
